      ...
      000062                        374 00106$:
                                    375 ;	main.c:7: P1=255;
      000062 75 90 FF         [24]  376 	mov	_P1,#0xff
                                    377 ;	main.c:8: for(unsigned int i=0;i<50000;i++); //delay
      000065 7E 00            [12]  378 	mov	r6,#0x00
      000067 7F 00            [12]  379 	mov	r7,#0x00
      000069                        380 00109$:
      000069 C3               [12]  381 	clr	c
      00006A EE               [12]  382 	mov	a,r6
      00006B 94 50            [12]  383 	subb	a,#0x50
      00006D EF               [12]  384 	mov	a,r7
      00006E 94 C3            [12]  385 	subb	a,#0xc3
      000070 50 07            [24]  386 	jnc	00101$
      000072 0E               [12]  387 	inc	r6
      000073 BE 00 F3         [24]  388 	cjne	r6,#0x00,00109$
      000076 0F               [12]  389 	inc	r7
      000077 80 F0            [24]  390 	sjmp	00109$
      000079                        391 00101$:
                                    392 ;	main.c:9: for(unsigned int i=0;i<50000;i++); //delay
      000079 7E 00            [12]  393 	mov	r6,#0x00
      00007B 7F 00            [12]  394 	mov	r7,#0x00
      00007D                        395 00112$:
      00007D C3               [12]  396 	clr	c
      00007E EE               [12]  397 	mov	a,r6
      00007F 94 50            [12]  398 	subb	a,#0x50
      000081 EF               [12]  399 	mov	a,r7
      000082 94 C3            [12]  400 	subb	a,#0xc3
      000084 50 07            [24]  401 	jnc	00102$
      000086 0E               [12]  402 	inc	r6
      000087 BE 00 F3         [24]  403 	cjne	r6,#0x00,00112$
      00008A 0F               [12]  404 	inc	r7
      00008B 80 F0            [24]  405 	sjmp	00112$
      00008D                        406 00102$:
                                    407 ;	main.c:11: P1=0;
      00008D 75 90 00         [24]  408 	mov	_P1,#0x00
                                    409 ;	main.c:13: for(unsigned int i=0;i<50000;i++); //delay
      000090 7E 00            [12]  410 	mov	r6,#0x00
      000092 7F 00            [12]  411 	mov	r7,#0x00
      000094                        412 00115$:
      000094 C3               [12]  413 	clr	c
      000095 EE               [12]  414 	mov	a,r6
      000096 94 50            [12]  415 	subb	a,#0x50
      000098 EF               [12]  416 	mov	a,r7
      000099 94 C3            [12]  417 	subb	a,#0xc3
      00009B 50 07            [24]  418 	jnc	00103$
      00009D 0E               [12]  419 	inc	r6
      00009E BE 00 F3         [24]  420 	cjne	r6,#0x00,00115$
      0000A1 0F               [12]  421 	inc	r7
      0000A2 80 F0            [24]  422 	sjmp	00115$
      0000A4                        423 00103$:
                                    424 ;	main.c:14: for(unsigned int i=0;i<50000;i++); //delay
      0000A4 7E 00            [12]  425 	mov	r6,#0x00
      0000A6 7F 00            [12]  426 	mov	r7,#0x00
      0000A8                        427 00118$:
      0000A8 C3               [12]  428 	clr	c
      0000A9 EE               [12]  429 	mov	a,r6
      0000AA 94 50            [12]  430 	subb	a,#0x50
      0000AC EF               [12]  431 	mov	a,r7
      0000AD 94 C3            [12]  432 	subb	a,#0xc3
      0000AF 50 B1            [24]  433 	jnc	00106$
      0000B1 0E               [12]  434 	inc	r6
                                    435 ;	main.c:17: return 0;
      0000B2 BE 00 F3         [24]  436 	cjne	r6,#0x00,00118$
      0000B5 0F               [12]  437 	inc	r7
                                    438 ;	main.c:18: }
      0000B6 80 F0            [24]  439 	sjmp	00118$
                                    440 	.area CSEG    (CODE)
                                    441 	.area CONST   (CODE)
                                    442 	.area XINIT   (CODE)
