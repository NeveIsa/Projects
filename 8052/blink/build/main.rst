      ...
      000062                        362 _main:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
                                    371 ;	main.c:6: while(1){
      000062                        372 00104$:
                                    373 ;	main.c:7: P1=255;
      000062 75 90 FF         [24]  374 	mov	_P1,#0xff
                                    375 ;	main.c:8: for(unsigned int i=0;i<20000;i++); //delay
      000065 7E 00            [12]  376 	mov	r6,#0x00
      000067 7F 00            [12]  377 	mov	r7,#0x00
      000069                        378 00107$:
      000069 C3               [12]  379 	clr	c
      00006A EE               [12]  380 	mov	a,r6
      00006B 94 20            [12]  381 	subb	a,#0x20
      00006D EF               [12]  382 	mov	a,r7
      00006E 94 4E            [12]  383 	subb	a,#0x4e
      000070 50 07            [24]  384 	jnc	00101$
      000072 0E               [12]  385 	inc	r6
      000073 BE 00 F3         [24]  386 	cjne	r6,#0x00,00107$
      000076 0F               [12]  387 	inc	r7
      000077 80 F0            [24]  388 	sjmp	00107$
      000079                        389 00101$:
                                    390 ;	main.c:11: P1=0;
      000079 75 90 00         [24]  391 	mov	_P1,#0x00
                                    392 ;	main.c:13: for(unsigned int i=0;i<20000;i++); //delay
      00007C 7E 00            [12]  393 	mov	r6,#0x00
      00007E 7F 00            [12]  394 	mov	r7,#0x00
      000080                        395 00110$:
      000080 C3               [12]  396 	clr	c
      000081 EE               [12]  397 	mov	a,r6
      000082 94 20            [12]  398 	subb	a,#0x20
      000084 EF               [12]  399 	mov	a,r7
      000085 94 4E            [12]  400 	subb	a,#0x4e
      000087 50 D9            [24]  401 	jnc	00104$
      000089 0E               [12]  402 	inc	r6
                                    403 ;	main.c:17: return 0;
      00008A BE 00 F3         [24]  404 	cjne	r6,#0x00,00110$
      00008D 0F               [12]  405 	inc	r7
                                    406 ;	main.c:18: }
      00008E 80 F0            [24]  407 	sjmp	00110$
                                    408 	.area CSEG    (CODE)
                                    409 	.area CONST   (CODE)
                                    410 	.area XINIT   (CODE)
