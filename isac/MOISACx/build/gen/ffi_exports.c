...
void  mgos_irrecv_nec_close(void *);
void * mgos_irrecv_nec_create(int, void (*)(int, void *), void *);
void  mgos_irsend_nec(int, int, int);
...
const struct mgos_ffi_export ffi_exports[] = {
  ...
  {"mgos_irrecv_nec_close", mgos_irrecv_nec_close},
  {"mgos_irrecv_nec_create", mgos_irrecv_nec_create},
  {"mgos_irsend_nec", mgos_irsend_nec},
